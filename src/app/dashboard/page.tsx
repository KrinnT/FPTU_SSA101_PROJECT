...
export default function DashboardPage() {
    ...
    const [hasAssessment, setHasAssessment] = useState<boolean | null>(null); // null = loading
                            ...
                            <Card className="glass-card md:col-span-3 lg:col-span-1">
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className={cn("font-bold", getSeverityColor(assessmentResult.scores.Depression))}>
                                            {assessmentResult.scores.Depression}
                                        </span>
                                    </div>
                                    <Progress value={(assessmentResult.scores.Depression / 42) * 100} className="h-1.5" />

                                    <div className="flex justify-between items-center">
                                        <span className="text-sm text-muted-foreground">Anxiety</span>
                                        <span className={cn("font-bold", getSeverityColor(assessmentResult.scores.Anxiety))}>
                                            {assessmentResult.scores.Anxiety}
                                        </span>
                                    </div>
                                    <Progress value={(assessmentResult.scores.Anxiety / 42) * 100} className="h-1.5" />

                                    <div className="flex justify-between items-center">
                                        <span className="text-sm text-muted-foreground">Stress</span>
                                        <span className={cn("font-bold", getSeverityColor(assessmentResult.scores.Stress))}>
                                            {assessmentResult.scores.Stress}
                                        </span>
                                    </div>
                                    <Progress value={(assessmentResult.scores.Stress / 42) * 100} className="h-1.5" />
                                </CardContent>
                            </Card>
                        )}
